...
class CanvAscii {
  ...
  onMouseMove(evt: MouseEvent | TouchEvent) {
    ...
    const x = ('clientX' in e ? e.clientX : 0) - bounds.left;
    const y = ('clientY' in e ? e.clientY : 0) - bounds.top;
    this.mouse = { x, y };
  }
    ...
    >
      <style>{`
        ...
        pre {
          ...
          left: 0;
          top: 0;
          background-image: radial-gradient(circle, #0EA5E9 0%, #22C55E 50%, #10B981 100%);
